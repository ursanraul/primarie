...
import { HttpRequest, HttpResponse, HttpHandler, HttpEvent, HttpInterceptor, HTTP_INTERCEPTORS, JsonpClientBackend } from '@angular/common/http';
...
export class FakeBackendInterceptor implements HttpInterceptor {
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function getRoles(){
            let roles = ['Admin', 'Functionar public', 'Cetatean'
            ];
